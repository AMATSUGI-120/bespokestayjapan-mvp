...
const config: StayCategoryConfig = {
  ...
  description:
    'A combined view of stays tagged tattoo-friendly and tattoo-consideration. Tattoo-friendly indicates lower-friction or clearer access; tattoo-consideration means the stay may still be useful, but details should be checked carefully before booking.',
