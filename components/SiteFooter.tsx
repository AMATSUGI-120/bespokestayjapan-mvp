...
const infoLinks: FooterLink[] = [
  ...
  { href: '/japan-private-tours-transfers-guide', label: 'Private tours guide' },
  { href: '/kansai-day-trips-practical-guide', label: 'Kansai day trips guide' },
  { href: '/japan-family-activity-planning-guide', label: 'Family activities guide' },
  { href: '/japan-esim-guide', label: 'Japan eSIM guide' },
  { href: '/japan-luggage-storage-guide', label: 'Luggage storage guide' },
  { href: '/japan-checkout-day-luggage-guide', label: 'Checkout day luggage guide' },
